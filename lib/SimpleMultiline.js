...
var SimpleMultiline = function (_React$Component) {
  ...
  _createClass(SimpleMultiline, [{
    ...
    value: function getExpandableField() {
      ...
      var centerTextInput = center ? textareaClass + ' ' + centerClass : { textareaClass: textareaClass };
    ...
    value: function render() {
      ...
      var autoresize = _props2.autoresize;

      var className = center ? textareaClass + ' ' + centerClass : { textareaClass: textareaClass };
      return _react2.default.createElement(
        'div',
        null,
